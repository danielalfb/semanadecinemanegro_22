          ...
          <ul id="nav-list">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <li lang="pt"><a href="./mostras/no_palco_nas_telas.php">MARIA JOSÉ NOVAIS OLIVEIRA: REJANE FARIA – NO
                    PALCO E NAS TELAS</a></li>
                <li lang="en"><a href="./mostras/no_palco_nas_telas.php">MARIA JOSÉ NOVAIS OLIVEIRA: REJANE FARIA – NO
                    PALCO E NAS TELAS</a></li>
                ...
                <li lang="pt"><a href="./mostras/nicho_54.php">SEMANA DE CINEMA NEGRO DE BELO HORIZONTE CONVIDA NICHO
                    54</a></li>
                <li lang="en"><a href="./mostras/nicho_54.php">SEMANA DE CINEMA NEGRO DE BELO HORIZONTE CONVIDA NICHO
                    54</a></li>
...
function getFooterOpen() { ?>
    ...
    <footer class="footer-distributed">
      ...
      <div class="footer-left">
        <div>
          <ul>
            <li lang="pt"><a href="/mostras/no_palco_nas_telas">MARIA JOSÉ NOVAIS OLIVEIRA: REJANE FARIA – NO PALCO E
                NAS TELAS</a></li>
            <li lang="en"><a href="/mostras/no_palco_nas_telas">MARIA JOSÉ NOVAIS OLIVEIRA: REJANE FARIA – NO PALCO E
                NAS TELAS</a></li>
