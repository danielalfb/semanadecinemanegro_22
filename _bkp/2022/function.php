...
<body>
  ...
  <div class="full-header">
    <div class="banner-header">
      <div class="subtitle"><img src="./img/detalhe_topBar.svg" alt="Logo">
    ...
    <div class="container-header header">
          ...
          <ul id="nav-list">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                ...
                <li lang="pt"><a href="/mostra_surreal16">Surreal16 Collective, Um Novo Olhar para o Cinema
                    Nigeriano</a></li>
                <li lang="en"><a href="/mostra_surreal16">Surreal16 Collective, a new look at nigerian cinema</a></li>
                <li lang="pt"><a href="/mostra_homenagem">Cinema, negritude e poesia: Uma homenagem a Sarah Maldoror</a>
                </li>
                <li lang="en"><a href="/mostra_homenagem">Film, Blackness and Poetry: A tribute to Sarah Maldoror</a>
                </li>
      ...
      <div id="language" class="language">
        <ul>
          <li lang="pt" id="pt_click" class="button_lang"><a><img lang="pt" src="./img/brazil.svg" alt="Brasil" />Brasil
              | Português</a></li>
          <li lang="en" id="en_click" class="button_lang"><a><img lang="en" src="./img/usa.svg" alt="USA" />USA |
              English</a></li>
        </ul>
      </div>
    </div>
